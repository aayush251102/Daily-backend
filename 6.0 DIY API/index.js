...
app.get("/jokes/:id",  (req,res) => {
    ...
    const found = jokes.find((joke) => joke.id === idd); // Find the joke by comparing IDs
    res.json(found);
});
...
app.get("/filter",  (req,res) => {
    ...
    const found = jokes.filter((joke) => joke.jokeType === type); // Find the joke by comparing IDs
    res.json(found);
});
...
app.put("/jokes/:id",  (req,res) => {
    ...
    const indx = jokes.findIndex((joke) => joke.id === id);
    jokes[indx] = newJoke;
    res.json(newJoke);
});
//6. PATCH a joke
